...
static int rsn_key_mgmt_to_bitfield(const u8 *s)
{
...
#ifdef CONFIG_SHA384
	if (RSN_SELECTOR_GET(s) == RSN_AUTH_KEY_MGMT_FT_PSK_SHA384)
		return WPA_KEY_MGMT_FT_PSK_SHA384;
	...
	if (RSN_SELECTOR_GET(s) == RSN_AUTH_KEY_MGMT_PSK_SHA384)
		return WPA_KEY_MGMT_PSK_SHA384;
#endif /* CONFIG_SHA384 */
...
u32 wpa_akm_to_suite(int akm)
{
	...
	if (akm & WPA_KEY_MGMT_PSK_SHA384)
		return RSN_AUTH_KEY_MGMT_PSK_SHA384;
